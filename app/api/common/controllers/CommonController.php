...
/**
 * Common Controller - Базовый контроллер.
 */
class CommonController extends Controller
{
	 ...
	 * @throws yii\web\ForbiddenHttpException Доступ запрещен.
	 * @throws yii\web\MethodNotAllowedHttpException Метод не разрешен.
	 */
